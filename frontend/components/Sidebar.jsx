...
import {
  ...
  ChevronLeft, ChevronRight, ChevronDown, Plus, FlaskConical, Dna, Atom, MessageSquare
} from 'lucide-react';
...
const NAV = [
  ...
  { id: '/vedika-labs',   Icon: Atom,          label: 'Vedika Labs'   },
];
...
export default function Sidebar({ isCollapsed = false, onToggleCollapse }) {
  ...
  const isGeneralTutor = pathname.startsWith('/vedika-ai/general-tutor');
  const isCodingTutor = pathname.startsWith('/vedika-ai/coding-tutor');
